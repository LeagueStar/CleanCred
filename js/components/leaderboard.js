      ...
      <div class="app-container">
        ...
        <div class="flex-between" style="margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
          <div>
            ...
            <h2>Community impact standings</h2>
            <p>Compare verified recovery contributions across citizens, neighborhoods and institutions.</p>
          </div>
            ...
            <div>
              ...
              ${currentUserEntry ? `
                ...
                <div style="font-size: 0.75rem; color: #84CC16;">
                  ${gapToNextRank > 0 ? `${Formatters.formatNumber(gapToNextRank)} Green Credits to reach #${aheadOfUser.rank}.` : "You currently lead this standing."}
                </div>
              ` : `
